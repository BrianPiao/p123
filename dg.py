...
#not complusory - on OS s/m like linux and macOS has more security
...
while(True):
  ...
  try:
    ...
    #3rd - green color rectangle , 4th - thickness of rect
    ...
    imgInverted = PIL.ImageOps.invert(image_bw_resized)
    pixel_filter = 20
